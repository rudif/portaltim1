...
class Beranda extends CI_Controller
{
    ...
    {
        $menu = $this->Beranda_model->get_all();

        $data = array(
            'menu_data' => $menu
        );
        $this->template->load('template','back/menu/Beranda_list', $data);
    }
/*
    public function read($id) 
    {
		...
		'is_parent' => $row->is_parent,
            ...
            $this->template->load('template','back/menu/menu_beranda', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','back/menu/beranda_form', $data);
    }
    ...
    public function update($id) 
    {
		...
		'is_parent' => set_value('is_parent', $row->is_parent),
            ...
            $this->template->load('template','back/menu/menu_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('menu'));
        }
    ...
    public function word()
    {
        ...
        $this->load->view('back/menu/menu_doc',$data);
    }
    ...
    function pdf()
    {
        ...
        $pdf = $this->pdf->load();
        $pdf->WriteHTML($html);
        $pdf->Output('back/menu/menu.pdf', 'D'); 
    }
*/
}
